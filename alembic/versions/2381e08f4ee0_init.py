...
Revision ID: 2381e08f4ee0
Revises: 
Create Date: 2025-08-07 12:43:07.122473
...
def upgrade() -> None:
    ...
    sa.Column('transaction_type', sa.Enum('IN', 'OUT', name='transactiontype'), nullable=True),
